    ...
    <div class="board-list">
        ...
        <table class="w3-table-all table-bordered">
            ...
            <tr v-for="(row, idx) in list" :key="idx">
                ...
                <td><a v-on:click="fnView(`${row.lecture_notice_id}`)" style="cursor: pointer;">{{ row.lecture_notice_title }}</a></td>
        ...
        <div class="common-buttons">
            <button type="button" class="w3-button w3-round w3-blue-gray" v-on:click="fnWrite(lecture_id)">등록</button>
        </div>
...
export default {
    ...
    methods: {
        fnGetList() {
            ...
            this.$axios.get(this.$serverUrl + "/prof/lecture/notice/list", {

        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <fieldset>
                        <legend>공지사항 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <button v-on:click="fnNoticeList(notice_id)" class="btn btn-outline-dark" type="button">
                                전체보기
                            </button>
                        </legend>
                ...
                <div class="col-md-6">
                    <fieldset>
                        <legend>학사일정&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <button v-on:click="fnScheList(sche_id)" class="btn btn-outline-dark" type="button">전체보기
                            </button>
                        </legend>

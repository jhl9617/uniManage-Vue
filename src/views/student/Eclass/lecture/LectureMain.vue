  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-6">
        <fieldset>
          <legend>공지사항 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button class="btn btn-outline-dark" type="button" v-on:click="fnNoticeList(lecture_id)">전체보기</button>
          </legend>
          <table class="w3-table-all table-bordered">
            ...
            <tr v-for="lectureNotice in sortedLectureNotice" :key="lectureNotice.lecture_notice_id">
              ...
              <td><a style="cursor: pointer;"
                     v-on:click="fnNotice(`${lectureNotice.lecture_notice_id}`)">{{ lectureNotice.lecture_notice_title }}</a></td>
      ...
      <div class="col-md-6">
        <fieldset>
          <legend>강의자료실 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button class="btn btn-outline-dark" style="cursor: pointer;" type="button"
                    v-on:click="fnLectureRoomList(lecture_id)">전체보기
            </button>
          </legend>
          <table class="w3-table-all table-bordered">
            <tr>
            ...
            <tr v-for="lectureRoom in sortedLectureRoom" :key="lectureRoom.lecture_room_id">
              ...
              <td><a style="cursor: pointer;"
                     v-on:click="fnLectureRoom(`${lectureRoom.lecture_room_id}`)">{{ lectureRoom.lecture_room_title }}</a></td>
    ...
    <div class="row">
      <div class="col-md-6">
        <fieldset>
          <legend>과제관리 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button class="btn btn-outline-dark" type="button" v-on:click="fnHomeworkList(lecture_id)">전체보기</button>
          </legend>
          <table class="w3-table-all table-bordered">
            <tr>
              <td>글번호</td>
            ...
            <tr v-for="homework in sortedHomework" :key="homework.lecture_notice_id">
              ...
              <td><a style="cursor: pointer;"
                     v-on:click="fnHomework(`${homework.homework_id}`)">{{ homework.homework_name }}</a></td>
        ...
        <fieldset>
          ...
          <table class="w3-table-all table-bordered">
            ...
            <tr v-for="freeboard in sortedFreeboard" :key="freeboard.free_id">
              ...
              <td><a style="cursor: pointer;" v-on:click="fnFreeboard(`${freeboard.free_id}`)">{{
